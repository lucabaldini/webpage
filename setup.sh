...
# location.
#
export WEBPAGE_ROOT=$SETUP_DIR
echo "WEBPAGE_ROOT set to " $IXPEOBSSIM_ROOT

#
# Add the root folder to the $PYTHONPATH so that we can effectively import
# the relevant modules.
#
export PYTHONPATH=$WEBPAGE_ROOT:$PYTHONPATH
...
#
export PATH=$WEBPAGE_ROOT/ixpeobssim/bin:$PATH
