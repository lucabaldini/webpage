...
latex_documents = [
    (master_doc, 'webpage.tex', 'webpage Documentation',
     'Luca Baldini', 'manual'),
]
...
man_pages = [
    (master_doc, 'webpage', 'webpage Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'webpage', 'webpage Documentation',
     author, 'webpage', 'One line description of project.',
     'Miscellaneous'),
]
